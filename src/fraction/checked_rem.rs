...
impl<Digit, const SEPARATOR: char, const DIGIT_BITNESS: usize> CheckedRem
    for Fraction<BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>
where
    for<'a> BigInt<Digit, SEPARATOR, DIGIT_BITNESS>: CheckedRem<Output = Option<BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>>
        + Mul<
...
impl<Digit, const SEPARATOR: char, const DIGIT_BITNESS: usize>
    CheckedRem<&Self> for Fraction<BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>
where
    for<'a> BigInt<Digit, SEPARATOR, DIGIT_BITNESS>: CheckedRem<Output = Option<BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>>
        + Mul<
            &'a BigInt<Digit, SEPARATOR, DIGIT_BITNESS>,
...
impl<Digit, const SEPARATOR: char, const DIGIT_BITNESS: usize>
    CheckedRem<Fraction<BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>>
    for &Fraction<BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>
where
    for<'a> BigInt<Digit, SEPARATOR, DIGIT_BITNESS>: CheckedRem<Output = Option<BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>>
        + NormalizeModuli<
...
impl<Digit, const SEPARATOR: char, const DIGIT_BITNESS: usize>
    CheckedRem<BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>
    for Fraction<BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>
where
    for<'a> &'a BigInt<Digit, SEPARATOR, DIGIT_BITNESS>: Mul<
        BigInt<Digit, SEPARATOR, DIGIT_BITNESS>,
...
impl<Digit, const SEPARATOR: char, const DIGIT_BITNESS: usize>
    CheckedRem<Fraction<Self>> for BigInt<Digit, SEPARATOR, DIGIT_BITNESS>
where
...
where
    for<'a> &'a BigInt<Digit, SEPARATOR, DIGIT_BITNESS>:
        Mul<Output = BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>,
    for<'a> BigInt<Digit, SEPARATOR, DIGIT_BITNESS>: CheckedRem<
            &'a BigInt<Digit, SEPARATOR, DIGIT_BITNESS>,
            Output = Option<BigInt<Digit, SEPARATOR, DIGIT_BITNESS>>,
        > + NormalizeModuli<
            &'a BigInt<Digit, SEPARATOR, DIGIT_BITNESS>,
