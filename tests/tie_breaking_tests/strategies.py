...
_tie_breakings = [
    _TieBreaking.AWAY_FROM_ZERO,
    _TieBreaking.TO_EVEN,
    _TieBreaking.TO_ODD,
    _TieBreaking.TOWARD_ZERO,
]
...
non_tie_breakings_values = _st.integers().filter(
    lambda value: value not in _tie_breakings_values
